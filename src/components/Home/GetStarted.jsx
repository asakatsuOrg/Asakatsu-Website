...
const GetStarted = () => {
  return (
    <div className="w-full max-w-[1536px] py-24 md:py-0 md:pt-24 px-4 lg:px-20 xl:px-56 flex flex-col items-center">
      ...
      <GetStartedSVG className="h-96 hidden md:block" />
    </div>
  );
};
